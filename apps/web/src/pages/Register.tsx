...
export default function Register() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-8rem)] items-center justify-center p-4">
      <div className={`w-full max-w-md space-y-8 ${isDark ? 'bg-zinc-800' : 'bg-white'
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label
                htmlFor="email"
                className={`block text-sm font-medium ${isDark ? 'text-zinc-200' : 'text-zinc-700'
                  }`}
              >
                Email address
              </label>
              <div className="mt-1 relative">
                <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none ${isDark ? 'text-zinc-400' : 'text-zinc-500'
                  }`}>
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-2 border ${isDark
          ...
          <button
            ...
            className={`w-full py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white ${isDark
